...
/*
 * Aggiungo delle funzionalità all'oggetto Stringa, ma non posso estendere String, dato che è una classe Final.
 * Quindi nella mia classe MagicString ho il riferimento ad un attributo di tipo String.
 * All'oggetto MagicString aggiungo la funzionalità di poter contare il numero di vocali di una stringa in input.
 * I restanti metodi sono stati ottenuto delegando l'attributo string. 
 * */
